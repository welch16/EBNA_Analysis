...
p <- ggplot(dt,aes(reorder(variable,-V1),V1))+
  ...
  theme(axis.text.x = element_text(angle = 90,size = 3))+xlab("Transcription factor")+ylab("Cluster proportion")+
  facet_wrap(~group)
...
```{r propotions,include=TRUE,echo=FALSE,fig.width=12,fig.heigth=8,dpi=800}
arrange_plot(prop_plots[[1]],2,"EBNA2")
arrange_plot(prop_plots[[2]],2,"EBNA3A")
arrange_plot(prop_plots[[3]],2,"EBNA3B")
arrange_plot(prop_plots[[4]],2,"EBNA3C")
arrange_plot(prop_plots[[5]],2,"RBPJ")
```
