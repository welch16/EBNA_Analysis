...
```{r barplot,include = TRUE,echo = FALSE,eval = TRUE, fig.width = 8,fig.height = 6,dpi=650,warning = FALSE}
...
```{r barplotDnase,include = TRUE,echo = FALSE,eval = TRUE, fig.width = 8,fig.height = 6,dpi=650,warning = FALSE}
