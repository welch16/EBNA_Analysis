...
```{r pies,include =TRUE,echo = FALSE,eval = TRUE, fig.width = 4, fig.height = 4 ,dpi = 500,warning = FALSE}
...
```{r piesDnase,include =TRUE,echo = FALSE,eval = TRUE, fig.width = 4, fig.height =4 ,dpi = 500,warning = FALSE}
