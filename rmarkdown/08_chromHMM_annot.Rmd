...
```{r barplot,include = TRUE,echo = FALSE,eval = TRUE, fig.width = 7,fig.height = 5,dpi=200,warning = FALSE}
plot
```
...
```{r barplotDnase,include = TRUE,echo = FALSE,eval = TRUE, fig.width = 7,fig.height = 5,dpi=200,warning = FALSE}
plot2
```
