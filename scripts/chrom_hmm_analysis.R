...
### Not all regions have an annotation. This must be due the liftover

## > sapply(ranges,length)
##  EBNA2 EBNA3A EBNA3B EBNA3C   JK92  JK234   RBPJ
##   8816   1651   3051   3611   8175   4293  10017
## > sapply(overlaps,function(x)length(unique(queryHits(x))))
##  EBNA2 EBNA3A EBNA3B EBNA3C   JK92  JK234   RBPJ
##   8695   1616   3007   3549   8069   4236   9883
